...
namespace mini_java_compiler
{
    ...
    enum SymbolConstants : int
    {
        ...
        SYMBOL_GTGTGT = 52, // '>>>'
        SYMBOL_GTGTGTEQ = 53, // '>>>='
        SYMBOL_ABSTRACT = 54, // abstract
        SYMBOL_BOOLEAN = 55, // boolean
        SYMBOL_BOOLEANLITERAL = 56, // BooleanLiteral
        SYMBOL_BREAK = 57, // break
        SYMBOL_BYTE = 58, // byte
        SYMBOL_CASE = 59, // case
        SYMBOL_CATCH = 60, // catch
        SYMBOL_CHAR = 61, // char
        SYMBOL_CLASS = 62, // class
        SYMBOL_CONTINUE = 63, // continue
        SYMBOL_DEFAULT = 64, // default
        SYMBOL_DO = 65, // do
        SYMBOL_DOUBLE = 66, // double
        SYMBOL_ELSE = 67, // else
        SYMBOL_EXTENDS = 68, // extends
        SYMBOL_FINAL = 69, // final
        SYMBOL_FINALLY = 70, // finally
        SYMBOL_FLOAT = 71, // float
        SYMBOL_FLOATINGPOINTLITERAL = 72, // FloatingPointLiteral
        SYMBOL_FLOATINGPOINTLITERALEXPONENT = 73, // FloatingPointLiteralExponent
        SYMBOL_FOR = 74, // for
        SYMBOL_HEXESCAPECHARLITERAL = 75, // HexEscapeCharLiteral
        SYMBOL_HEXINTEGERLITERAL = 76, // HexIntegerLiteral
        SYMBOL_IDENTIFIER = 77, // Identifier
        SYMBOL_IF = 78, // if
        SYMBOL_IMPLEMENTS = 79, // implements
        SYMBOL_IMPORT = 80, // import
        SYMBOL_INDIRECTCHARLITERAL = 81, // IndirectCharLiteral
        SYMBOL_INSTANCEOF = 82, // instanceof
        SYMBOL_INT = 83, // int
        SYMBOL_INTERFACE = 84, // interface
        SYMBOL_LONG = 85, // long
        SYMBOL_NATIVE = 86, // native
        SYMBOL_NEW = 87, // new
        SYMBOL_NULLLITERAL = 88, // NullLiteral
        SYMBOL_OCTALESCAPECHARLITERAL = 89, // OctalEscapeCharLiteral
        SYMBOL_OCTALINTEGERLITERAL = 90, // OctalIntegerLiteral
        SYMBOL_PACKAGE = 91, // package
        SYMBOL_PRIVATE = 92, // private
        SYMBOL_PROTECTED = 93, // protected
        SYMBOL_PUBLIC = 94, // public
        SYMBOL_RETURN = 95, // return
        SYMBOL_SHORT = 96, // short
        SYMBOL_STANDARDESCAPECHARLITERAL = 97, // StandardEscapeCharLiteral
        SYMBOL_STARTWITHNOZERODECIMALINTEGERLITERAL = 98, // StartWithNoZeroDecimalIntegerLiteral
        SYMBOL_STARTWITHZERODECIMALINTEGERLITERAL = 99, // StartWithZeroDecimalIntegerLiteral
        SYMBOL_STATIC = 100, // static
        SYMBOL_STRINGLITERAL = 101, // StringLiteral
        SYMBOL_SUPER = 102, // super
        SYMBOL_SWITCH = 103, // switch
        SYMBOL_SYNCHRONIZED = 104, // synchronized
        SYMBOL_THIS = 105, // this
        SYMBOL_THROW = 106, // throw
        SYMBOL_THROWS = 107, // throws
        SYMBOL_TRANSIENT = 108, // transient
        SYMBOL_TRY = 109, // try
        SYMBOL_VOID = 110, // void
        SYMBOL_VOLATILE = 111, // volatile
        SYMBOL_WHILE = 112, // while
        SYMBOL_ABSTRACTMETHODDECLARATION = 113, // <AbstractMethodDeclaration>
        SYMBOL_ADDITIVEEXPRESSION = 114, // <AdditiveExpression>
        SYMBOL_ANDEXPRESSION = 115, // <AndExpression>
        SYMBOL_ARGUMENTLIST = 116, // <ArgumentList>
        SYMBOL_ARRAYACCESS = 117, // <ArrayAccess>
        SYMBOL_ARRAYCREATIONEXPRESSION = 118, // <ArrayCreationExpression>
        SYMBOL_ARRAYINITIALIZER = 119, // <ArrayInitializer>
        SYMBOL_ARRAYTYPE = 120, // <ArrayType>
        SYMBOL_ASSIGNMENT = 121, // <Assignment>
        SYMBOL_ASSIGNMENTEXPRESSION = 122, // <AssignmentExpression>
        SYMBOL_ASSIGNMENTOPERATOR = 123, // <AssignmentOperator>
        SYMBOL_BLOCK = 124, // <Block>
        SYMBOL_BLOCKSTATEMENT = 125, // <BlockStatement>
        SYMBOL_BLOCKSTATEMENTS = 126, // <BlockStatements>
        SYMBOL_BREAKSTATEMENT = 127, // <BreakStatement>
        SYMBOL_CASTEXPRESSION = 128, // <CastExpression>
        SYMBOL_CATCHCLAUSE = 129, // <CatchClause>
        SYMBOL_CATCHES = 130, // <Catches>
        SYMBOL_CHARACTERLITERAL = 131, // <CharacterLiteral>
        SYMBOL_CLASSBODY = 132, // <ClassBody>
        SYMBOL_CLASSBODYDECLARATION = 133, // <ClassBodyDeclaration>
        SYMBOL_CLASSBODYDECLARATIONS = 134, // <ClassBodyDeclarations>
        SYMBOL_CLASSDECLARATION = 135, // <ClassDeclaration>
        SYMBOL_CLASSINSTANCECREATIONEXPRESSION = 136, // <ClassInstanceCreationExpression>
        SYMBOL_CLASSMEMBERDECLARATION = 137, // <ClassMemberDeclaration>
        SYMBOL_CLASSORINTERFACETYPE = 138, // <ClassOrInterfaceType>
        SYMBOL_CLASSTYPE = 139, // <ClassType>
        SYMBOL_CLASSTYPELIST = 140, // <ClassTypeList>
        SYMBOL_COMPILATIONUNIT = 141, // <CompilationUnit>
        SYMBOL_CONDITIONALANDEXPRESSION = 142, // <ConditionalAndExpression>
        SYMBOL_CONDITIONALEXPRESSION = 143, // <ConditionalExpression>
        SYMBOL_CONDITIONALOREXPRESSION = 144, // <ConditionalOrExpression>
        SYMBOL_CONSTANTDECLARATION = 145, // <ConstantDeclaration>
        SYMBOL_CONSTANTEXPRESSION = 146, // <ConstantExpression>
        SYMBOL_CONSTRUCTORBODY = 147, // <ConstructorBody>
        SYMBOL_CONSTRUCTORDECLARATION = 148, // <ConstructorDeclaration>
        SYMBOL_CONSTRUCTORDECLARATOR = 149, // <ConstructorDeclarator>
        SYMBOL_CONTINUESTATEMENT = 150, // <ContinueStatement>
        SYMBOL_DECIMALINTEGERLITERAL = 151, // <DecimalIntegerLiteral>
        SYMBOL_DIMEXPR = 152, // <DimExpr>
        SYMBOL_DIMEXPRS = 153, // <DimExprs>
        SYMBOL_DIMS = 154, // <Dims>
        SYMBOL_DOSTATEMENT = 155, // <DoStatement>
        SYMBOL_EMPTYSTATEMENT = 156, // <EmptyStatement>
        SYMBOL_EQUALITYEXPRESSION = 157, // <EqualityExpression>
        SYMBOL_EXCLUSIVEOREXPRESSION = 158, // <ExclusiveOrExpression>
        SYMBOL_EXPLICITCONSTRUCTORINVOCATION = 159, // <ExplicitConstructorInvocation>
        SYMBOL_EXPRESSION = 160, // <Expression>
        SYMBOL_EXPRESSIONSTATEMENT = 161, // <ExpressionStatement>
        SYMBOL_EXTENDSINTERFACES = 162, // <ExtendsInterfaces>
        SYMBOL_FIELDACCESS = 163, // <FieldAccess>
        SYMBOL_FIELDDECLARATION = 164, // <FieldDeclaration>
        SYMBOL_FINALLY2 = 165, // <Finally>
        SYMBOL_FLOATINGPOINTTYPE = 166, // <FloatingPointType>
        SYMBOL_FLOATPOINTLITERAL = 167, // <FloatPointLiteral>
        SYMBOL_FORINIT = 168, // <ForInit>
        SYMBOL_FORMALPARAMETER = 169, // <FormalParameter>
        SYMBOL_FORMALPARAMETERLIST = 170, // <FormalParameterList>
        SYMBOL_FORSTATEMENT = 171, // <ForStatement>
        SYMBOL_FORSTATEMENTNOSHORTIF = 172, // <ForStatementNoShortIf>
        SYMBOL_FORUPDATE = 173, // <ForUpdate>
        SYMBOL_IFTHENELSESTATEMENT = 174, // <IfThenElseStatement>
        SYMBOL_IFTHENELSESTATEMENTNOSHORTIF = 175, // <IfThenElseStatementNoShortIf>
        SYMBOL_IFTHENSTATEMENT = 176, // <IfThenStatement>
        SYMBOL_IMPORTDECLARATION = 177, // <ImportDeclaration>
        SYMBOL_IMPORTDECLARATIONS = 178, // <ImportDeclarations>
        SYMBOL_INCLUSIVEOREXPRESSION = 179, // <InclusiveOrExpression>
        SYMBOL_INTEGERLITERAL = 180, // <IntegerLiteral>
        SYMBOL_INTEGRALTYPE = 181, // <IntegralType>
        SYMBOL_INTERFACEBODY = 182, // <InterfaceBody>
        SYMBOL_INTERFACEDECLARATION = 183, // <InterfaceDeclaration>
        SYMBOL_INTERFACEMEMBERDECLARATION = 184, // <InterfaceMemberDeclaration>
        SYMBOL_INTERFACEMEMBERDECLARATIONS = 185, // <InterfaceMemberDeclarations>
        SYMBOL_INTERFACES = 186, // <Interfaces>
        SYMBOL_INTERFACETYPE = 187, // <InterfaceType>
        SYMBOL_INTERFACETYPELIST = 188, // <InterfaceTypeList>
        SYMBOL_LABELEDSTATEMENT = 189, // <LabeledStatement>
        SYMBOL_LABELEDSTATEMENTNOSHORTIF = 190, // <LabeledStatementNoShortIf>
        SYMBOL_LEFTHANDSIDE = 191, // <LeftHandSide>
        SYMBOL_LITERAL = 192, // <Literal>
        SYMBOL_LOCALVARIABLEDECLARATION = 193, // <LocalVariableDeclaration>
        SYMBOL_LOCALVARIABLEDECLARATIONSTATEMENT = 194, // <LocalVariableDeclarationStatement>
        SYMBOL_METHODBODY = 195, // <MethodBody>
        SYMBOL_METHODDECLARATION = 196, // <MethodDeclaration>
        SYMBOL_METHODDECLARATOR = 197, // <MethodDeclarator>
        SYMBOL_METHODHEADER = 198, // <MethodHeader>
        SYMBOL_METHODINVOCATION = 199, // <MethodInvocation>
        SYMBOL_MODIFIER = 200, // <Modifier>
        SYMBOL_MODIFIERS = 201, // <Modifiers>
        SYMBOL_MULTIPLICATIVEEXPRESSION = 202, // <MultiplicativeExpression>
        SYMBOL_NAME = 203, // <Name>
        SYMBOL_NUMERICTYPE = 204, // <NumericType>
        SYMBOL_PACKAGEDECLARATION = 205, // <PackageDeclaration>
        SYMBOL_POSTDECREMENTEXPRESSION = 206, // <PostDecrementExpression>
        SYMBOL_POSTFIXEXPRESSION = 207, // <PostfixExpression>
        SYMBOL_POSTINCREMENTEXPRESSION = 208, // <PostIncrementExpression>
        SYMBOL_PREDECREMENTEXPRESSION = 209, // <PreDecrementExpression>
        SYMBOL_PREINCREMENTEXPRESSION = 210, // <PreIncrementExpression>
        SYMBOL_PRIMARY = 211, // <Primary>
        SYMBOL_PRIMARYNONEWARRAY = 212, // <PrimaryNoNewArray>
        SYMBOL_PRIMITIVETYPE = 213, // <PrimitiveType>
        SYMBOL_QUALIFIEDNAME = 214, // <QualifiedName>
        SYMBOL_REFERENCETYPE = 215, // <ReferenceType>
        SYMBOL_RELATIONALEXPRESSION = 216, // <RelationalExpression>
        SYMBOL_RETURNSTATEMENT = 217, // <ReturnStatement>
        SYMBOL_SHIFTEXPRESSION = 218, // <ShiftExpression>
        SYMBOL_SIMPLENAME = 219, // <SimpleName>
        SYMBOL_SINGLETYPEIMPORTDECLARATION = 220, // <SingleTypeImportDeclaration>
        SYMBOL_STATEMENT = 221, // <Statement>
        SYMBOL_STATEMENTEXPRESSION = 222, // <StatementExpression>
        SYMBOL_STATEMENTEXPRESSIONLIST = 223, // <StatementExpressionList>
        SYMBOL_STATEMENTNOSHORTIF = 224, // <StatementNoShortIf>
        SYMBOL_STATEMENTWITHOUTTRAILINGSUBSTATEMENT = 225, // <StatementWithoutTrailingSubstatement>
        SYMBOL_STATICINITIALIZER = 226, // <StaticInitializer>
        SYMBOL_SUPER2 = 227, // <Super>
        SYMBOL_SWITCHBLOCK = 228, // <SwitchBlock>
        SYMBOL_SWITCHBLOCKSTATEMENTGROUP = 229, // <SwitchBlockStatementGroup>
        SYMBOL_SWITCHBLOCKSTATEMENTGROUPS = 230, // <SwitchBlockStatementGroups>
        SYMBOL_SWITCHLABEL = 231, // <SwitchLabel>
        SYMBOL_SWITCHLABELS = 232, // <SwitchLabels>
        SYMBOL_SWITCHSTATEMENT = 233, // <SwitchStatement>
        SYMBOL_SYNCHRONIZEDSTATEMENT = 234, // <SynchronizedStatement>
        SYMBOL_THROWS2 = 235, // <Throws>
        SYMBOL_THROWSTATEMENT = 236, // <ThrowStatement>
        SYMBOL_TRYSTATEMENT = 237, // <TryStatement>
        SYMBOL_TYPE = 238, // <Type>
        SYMBOL_TYPEDECLARATION = 239, // <TypeDeclaration>
        SYMBOL_TYPEDECLARATIONS = 240, // <TypeDeclarations>
        SYMBOL_TYPEIMPORTONDEMANDDECLARATION = 241, // <TypeImportOnDemandDeclaration>
        SYMBOL_UNARYEXPRESSION = 242, // <UnaryExpression>
        SYMBOL_UNARYEXPRESSIONNOTPLUSMINUS = 243, // <UnaryExpressionNotPlusMinus>
        SYMBOL_VARIABLEDECLARATOR = 244, // <VariableDeclarator>
        SYMBOL_VARIABLEDECLARATORID = 245, // <VariableDeclaratorId>
        SYMBOL_VARIABLEDECLARATORS = 246, // <VariableDeclarators>
        SYMBOL_VARIABLEINITIALIZER = 247, // <VariableInitializer>
        SYMBOL_VARIABLEINITIALIZERS = 248, // <VariableInitializers>
        SYMBOL_WHILESTATEMENT = 249, // <WhileStatement>
        SYMBOL_WHILESTATEMENTNOSHORTIF = 250  // <WhileStatementNoShortIf>
    };
    ...
    public class MyParser
    {
        ...
        private void Init(Stream stream)
        {
            ...
            parser.OnReduce += new LR1Parser.ReduceHandler(ReduceEvent);
            parser.OnTokenRead += new LR1Parser.TokenReadHandler(TokenReadEvent);
            parser.OnAccept += new LR1Parser.AcceptHandler(AcceptEvent);
        ...
        private void ReduceEvent(LR1Parser parser, ReduceEventArgs args)
        {
            try
            {
                args.Token.UserObject = CreateObject(args.Token);
        ...
        private void AcceptEvent(LR1Parser parser, AcceptEventArgs args)
        {
